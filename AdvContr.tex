...
\input{./files/observer.tex}
\input{./files/systemIdentification.tex}
\input{./files/Discretization}
\input{./files/hInf.tex}
\input{./files/nichtLinSysteme.tex}
\input{./files/z-Transformationen}
\input{./files/matrizen.tex}
\input{./files/beschreibungsfunktionen.tex}
\end{document}
